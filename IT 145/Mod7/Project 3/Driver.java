...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        Scanner scnr = new Scanner(System.in); // scanner to allow user to input
        char choice = 0;
        ...
        // made a switch loop to keep user in the system until user inputs 'x'
        while (choice != 'x'){
        	displayMenu();
    ...
    public static void printShipList(String listType) {
        ...
        if (listType == "name") {
            ...
            //added spacing and '-' to give enough area to put the categories over the correct information
            System.out.println("---------------------------------------------------------------");
    ...
    public static void addShip() {
        ...
        if (flag == 1) {
        	//notifies the user if Ship is in they system and does not needed to be added.
